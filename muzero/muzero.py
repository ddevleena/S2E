...
class MuZero:
    ...
    def train(self, log_in_tensorboard=True):
        ...
        [
            self_play_worker.continuous_self_play.remote(
                self.shared_storage_worker, self.replay_buffer_worker, i
            )
            for i, self_play_worker in enumerate(self.self_play_workers)
        ]
    ...
    def logging_loop(self, num_gpus):
        ...
        self.test_worker.continuous_self_play.remote(
            self.shared_storage_worker, None, 10, True
        )
        ...
        try:
            while info["training_step"] < self.config.training_steps:
                ...
                if info["training_step"] > counter:
                    ...
                    writer.add_scalar("2.Workers/3.Learning_rate", info["lr"], counter)
                    writer.add_scalar(
                    ...
                    writer.add_scalar("4.Outcome/1.MuZero_Success_Rate", info["muzero_success"], counter)
                    writer.add_scalar("4.Outcome/2.Opponent_Success_Rate", info["opponent_success"], counter)
                    writer.add_scalar("4.Outcome/3.Draw_Rate", info["draw_rate"], counter)
                    print(
    ...
    if len(sys.argv) == 2:
        ...
        while True:
            ...
            if choice == 0:
                ...
                muzero.test(render=True, opponent="expert", muzero_player=None)
            elif choice == 3:
